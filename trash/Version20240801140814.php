 ...
 */
final class Version20240801140814 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE addresses (id INT AUTO_INCREMENT NOT NULL, country VARCHAR(255) NOT NULL, governorate VARCHAR(255) NOT NULL, district VARCHAR(255) NOT NULL, street VARCHAR(255) NOT NULL, building VARCHAR(255) NOT NULL, floor INT NOT NULL, apartment INT NOT NULL, PRIMARY KEY(id))');
        ...
        $this->addSql('CREATE TABLE comments (id INT AUTO_INCREMENT NOT NULL, customer VARCHAR(255) DEFAULT NULL, product VARCHAR(255) NOT NULL, timestamp DATETIME NOT NULL, content VARCHAR(1000) NOT NULL, rating DOUBLE PRECISION NOT NULL, PRIMARY KEY(id))');
        ...
        $this->addSql('CREATE TABLE order_items (id INT AUTO_INCREMENT NOT NULL, customer VARCHAR(255) NOT NULL, product VARCHAR(255) NOT NULL, quantity INT NOT NULL, totalPriceCents INT NOT NULL, PRIMARY KEY(id))');
        $this->addSql('CREATE TABLE orders (id INT AUTO_INCREMENT NOT NULL, customer VARCHAR(255) NOT NULL, receipt VARCHAR(255) NOT NULL, dateCreated DATETIME NOT NULL, dateDelivered DATETIME NOT NULL, status VARCHAR(255) NOT NULL, totalCents INT NOT NULL, PRIMARY KEY(id))');
        $this->addSql('CREATE TABLE products (id INT AUTO_INCREMENT NOT NULL, name VARCHAR(255) NOT NULL, description VARCHAR(1000) NOT NULL, category VARCHAR(255) NOT NULL, photo VARCHAR(255) NOT NULL, unit_price_cents INT NOT NULL, avg_rating DOUBLE PRECISION NOT NULL, PRIMARY KEY(id))');
