 ...
 */
final class Version20240903200612 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE administrators ADD created_at DATETIME NOT NULL, ADD updated_at DATETIME NOT NULL, ADD deleted_at DATETIME DEFAULT NULL, ADD phone_number VARCHAR(20) NOT NULL');
        ...
        $this->addSql('ALTER TABLE customers ADD created_at DATETIME NOT NULL, ADD updated_at DATETIME NOT NULL, ADD deleted_at DATETIME DEFAULT NULL, ADD phone_number VARCHAR(20) DEFAULT NULL');
        ...
        $this->addSql('ALTER TABLE products ADD created_at DATETIME NOT NULL, ADD updated_at DATETIME NOT NULL, ADD deleted_at DATETIME DEFAULT NULL, ADD manufacturer_id INT DEFAULT NULL, CHANGE avg_rating avg_rating NUMERIC(2, 1) DEFAULT 0 NOT NULL, CHANGE unit_price_cents unit_price_in_cents INT NOT NULL');
