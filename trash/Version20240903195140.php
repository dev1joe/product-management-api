 ...
 */
final class Version20240903195140 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE Manufacturer (id INT AUTO_INCREMENT NOT NULL, name VARCHAR(255) NOT NULL, email VARCHAR(255) NOT NULL, logo VARCHAR(255) NOT NULL, product_count INT NOT NULL, created_at DATETIME NOT NULL, updated_at DATETIME NOT NULL, PRIMARY KEY(id))');
        ...
        $this->addSql('ALTER TABLE administrators ADD created_at DATETIME NOT NULL, ADD updated_at DATETIME NOT NULL, ADD deleted_at DATETIME DEFAULT NULL, ADD phone_number VARCHAR(255) NOT NULL');
        ...
        $this->addSql('ALTER TABLE customers ADD created_at DATETIME NOT NULL, ADD updated_at DATETIME NOT NULL, ADD deleted_at DATETIME DEFAULT NULL, ADD phone_number VARCHAR(255) DEFAULT NULL');
        ...
        $this->addSql('ALTER TABLE products ADD created_at DATETIME NOT NULL, ADD updated_at DATETIME NOT NULL, ADD manufacturer_id INT DEFAULT NULL, CHANGE avg_rating avg_rating NUMERIC(2, 1) DEFAULT 0 NOT NULL, CHANGE unit_price_cents unit_price_in_cents INT NOT NULL');
        ...
        $this->addSql('ALTER TABLE warehouses ADD created_at DATETIME NOT NULL, ADD updated_at DATETIME NOT NULL, ADD deleted_at DATETIME DEFAULT NULL, CHANGE address address_id INT DEFAULT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE products DROP created_at, DROP updated_at, DROP manufacturer_id, CHANGE avg_rating avg_rating NUMERIC(2, 1) DEFAULT \'0.0\' NOT NULL, CHANGE unit_price_in_cents unit_price_cents INT NOT NULL');
