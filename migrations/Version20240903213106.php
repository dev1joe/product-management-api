...
final class Version20240903213106 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE manufacturers (id INT AUTO_INCREMENT NOT NULL, name VARCHAR(255) NOT NULL, email VARCHAR(255) NOT NULL, logo VARCHAR(255) NOT NULL, product_count INT NOT NULL, created_at DATETIME DEFAULT CURRENT_TIMESTAMP NOT NULL, updated_at DATETIME DEFAULT NULL, PRIMARY KEY(id))');
        ...
        $this->addSql('ALTER TABLE products ADD CONSTRAINT FK_B3BA5A5AA23B42D FOREIGN KEY (manufacturer_id) REFERENCES manufacturers (id) ON DELETE RESTRICT');
